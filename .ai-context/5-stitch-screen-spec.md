...
* 📐 **Autoridad del Diseño:** Utilizar el archivo `DESIGN.md` como la máxima autoridad y última palabra en lo que respecta a estilos visuales, paletas de colores, tipografías y espaciados UI. Esta especificación (`5-stitch-screen-spec.md`) funge exclusivamente como la autoridad funcional y lógica de las pantallas.
