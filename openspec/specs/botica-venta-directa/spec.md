# botica-venta-directa Specification

## Purpose

Defines the requirements and business rules for over-the-counter (OTC) direct sales in the veterinary pharmacy/petshop (`botica-venta-directa`), enforcing mandatory automated blocking on restricted pharmaceuticals (`RequiereReceta == true`) unless a valid medical prescription is attached.
