# Tasks: Rediseño de Registrar Cliente
...
|------|------|-----------|----------------------|-----------------|-------------------|
| 1 | Rediseñar vista registrar cliente con Bento e iconos | Single PR | npm run build | npm run dev | src/Frontend/src/views/Clientes/RegistrarCliente.tsx |

## Phase 1: Foundation (Visual Container & Title)

- [x] 1.1 Modificar el padding contenedor de `RegistrarCliente.tsx` a `p-6 md:pt-4 md:px-10 md:pb-10`.
- [x] 1.2 Estructurar el encabezado de página usando el componente `PageHeader` con el estilo y enlaces correspondientes.

## Phase 2: Bento Forms (Personal Info & Contact)
