...
2. **Sistema de Componentes Modular**:
   - `KpiCard.tsx`: Componente de métricas reutilizable con soporte de variantes pastel (`orange`, `blue`, `green`, `purple`, `red`).
   ...
   - `LowStockAlert.tsx`: Banner de aviso de productos en stock mínimo.
